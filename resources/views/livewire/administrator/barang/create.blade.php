            ...
            <form action="{{ route('admin.barang.save') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <input name="namaBarang" type="text" placeholder="Masukkan Nama Toko"
                    ...
                    <div class="form-group">
                        <input name="deskripsi" type="text" placeholder="Masukkan deskripsi barang" autocomplete="off"
                            class="form-control @error('deskripsi') is-invalid @enderror">
                        @error('deskripsi') <span class="invalid-feedback">{{ $message }}</span> @enderror
                    </div>
                    <label>Harga</label>
                    <div class="form-group">
                        <input name="harga" type="text" placeholder="Masukkan harga barang" autocomplete="off"
                            class="form-control @error('harga') is-invalid @enderror">
                        @error('harga') <span class="invalid-feedback">{{ $message }}</span> @enderror
                    </div>
                    <label>Stok</label>
                    <div class="form-group">
                        <input name="stok" type="text" placeholder="Masukkan stok barang" autocomplete="off"
                            class="form-control @error('stok') is-invalid @enderror">
                        @error('stok') <span class="invalid-feedback">{{ $message }}</span> @enderror
                    </div>
                    <label>Gambar</label>
                    <div class="form-group">
                        <input name="gambar" type="file" placeholder="Masukkan gambar barang" class="form-control @error('gambar') is-invalid @enderror">
